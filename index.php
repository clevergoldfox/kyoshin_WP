...
<body>
    <div class="content">
        ...
        <div class="section-4">
            ...
            <button class="budget-btn">施工事例を見る</button>
        </div>
        <div class="section-5">
            <h1 class="badge-text">REASON</h1>
            <div class="title">
                <h1>株式会社共進が選ばれる<br class="sp">
                    4つの理由</h1>
            </div>
            <div class="sec-content">
                <div class="card">
        ...
        <div class="section-8">
            <h1 class="badge-text">QUESTION</h1>
            <div class="title">
                <h1>よくある質問</h1>
            </div>
            <div class="sec-content">
        ...
        <div class="section-9">
            <h1 class="badge-text">COMPANY</h1>
            <div class="title">
                <h1>会社概要</h1>
            </div>
            <div class="sec-content">
